...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="bg-white shadow-md rounded-lg p-6">
        <form action="{{ route('broadcast-recipients.store') }}" method="POST">
            @csrf
            ...
            <div class="mb-4 flex items-center">
                <input type="checkbox" name="receive_cctv" id="receive_cctv" value="1" {{ old('receive_cctv') ? 'checked' : '' }} 
            ...
            <div class="mb-4 flex items-center">
                <input type="checkbox" name="receive_social" id="receive_social" value="1" {{ old('receive_social') ? 'checked' : '' }}
                       class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
