        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
            ...
            <div class="card bg-gradient-to-br from-warning to-warning-focus text-warning-content shadow-xl">
                <div class="card-body">
                    ...
                    <p class="mb-4 opacity-90">Send automated WhatsApp messages with detection results to recipients</p>
                    <div class="card-actions justify-end">
                        <a href="{{ route('broadcast.send') }}" class="btn btn-sm btn-warning-content">
                            Send Broadcast
                        </a>
                        <a href="{{ route('sender-numbers.index') }}" class="btn btn-sm btn-outline btn-warning-content">
                            Manage Accounts
                        </a>
                        <a href="{{ route('broadcast-recipients.index') }}"
                            class="btn btn-sm btn-outline btn-warning-content">
                            Manage Recipients
                        </a>
                    </div>
                </div>
                    ...
                    @if($recentActivities && $recentActivities->count() > 0)
                        <div class="space-y-3">
                            @foreach($recentActivities as $activity)
                                <div
                                    class="flex items-center space-x-3 p-3 bg-base-200 rounded-lg hover:bg-base-300 transition-colors">
