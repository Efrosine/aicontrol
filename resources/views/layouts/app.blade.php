                            ...
                            <a href="{{ auth()->user()->role === 'admin' ? route('dashboard') : route('home') }}" 
                               class="btn btn-ghost {{ request()->routeIs('dashboard', 'home') ? 'btn-active' : '' }}">
                                <svg class="w-5 h-5 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 5a2 2 0 012-2h4a2 2 0 012 2v0M8 5a2 2 0 00-2 2v0h12a2 2 0 00-2-2v0"></path>
                                </svg>
                                Dashboard
                            </a>
                        </li>
                            ...
                            <details class="dropdown">
                                ...
                                <ul class="dropdown-content menu bg-base-100 rounded-box z-[9999] w-52 p-2 shadow-lg border border-base-300" style="z-index: 9999 !important;">
                                    @if(auth()->user()->role === 'admin')
                                        ...
                                        <li><a href="{{ route('admin.social_detection_results.index') }}" class="flex items-center">
                                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <details class="dropdown">
                                ...
                                <ul class="dropdown-content menu bg-base-100 rounded-box z-[9999] w-52 p-2 shadow-lg border border-base-300" style="z-index: 9999 !important;">
                                    ...
                                    <li><a href="{{ route('cctv.user-view') }}" class="flex items-center">
                                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14.828 14.828a4 4 0 01-5.656 0M9 10h1m4 0h1m-6 4h8m-5-10v20m5-20v20"></path>
                                        </svg>
                                        Live Camera View
                                    </a></li>
                                    ...
                                    <li><a href="{{ route('admin.storage.settings.index') }}" class="flex items-center">
                                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
