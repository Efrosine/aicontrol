            ...
            <div class="navbar bg-base-100 shadow-md">
                <div class="flex-1">
                    <a href="{{ auth()->user()->role === 'admin' ? route('dashboard') : route('home') }}"
                        class="btn btn-ghost text-xl">AI Control Panel</a>
                </div>
                <div class="flex-none">
                    <div class="dropdown dropdown-end">
                        ...
                        <ul tabindex="0" class="menu dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52">
                            ...
                            @if(auth()->user()->role === 'admin')
                                ...
                                <li><a href="{{ route('cctvs.index') }}">CCTV Cameras</a></li>
                            ...
                            <li>
                                <form method="POST" action="{{ route('logout') }}">
                                    @csrf
                                    <button type="submit"
                                        class="w-full text-left hover:bg-base-200 rounded-lg py-2 px-4">Logout</button>
                                </form>
                            </li>
                        </ul>
                    </div>
