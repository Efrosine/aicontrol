...
<div class="bg-white rounded-lg shadow-md p-6">
    <div class="flex items-center mb-6">
        ...
        <h1 class="text-2xl font-bold text-gray-900">Add New CCTV Camera</h1>
    </div>
    ...
    <form action="{{ route('cctvs.store') }}" method="POST" class="space-y-6">
        @csrf
