        ...
        @if(isset($detectionConfig))
            <div class="mt-6 bg-gray-50 rounded-lg p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div class="text-center">
                        <div
                            class="text-2xl font-bold {{ isset($detectionConfig['enable_video']) && $detectionConfig['enable_video'] ? 'text-green-600' : 'text-red-600' }}">
                    ...
                    <div class="text-center">
                        <div
                            class="text-2xl font-bold {{ isset($detectionConfig['enable_screenshot']) && $detectionConfig['enable_screenshot'] ? 'text-green-600' : 'text-red-600' }}">
                    ...
                    <div class="text-center">
                        <div
                            class="text-2xl font-bold {{ isset($detectionConfig['external_endpoint']) && $detectionConfig['external_endpoint'] ? 'text-green-600' : 'text-gray-400' }}">
