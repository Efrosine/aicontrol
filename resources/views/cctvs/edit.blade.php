...
@section('content')
    <div class="container mx-auto px-4 py-8">
        <div class="flex items-center mb-6">
            ...
            <h1 class="text-2xl font-bold">Edit CCTV Camera</h1>
        </div>

        <div class="card">
            <div class="card-body">
                <form action="{{ route('cctvs.update', $cctv) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-control mb-4">
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name', $cctv->name) }}" required
                    ...
                    <div class="form-control mb-4">
                        ...
                        <input type="text" name="location" id="location" value="{{ old('location', $cctv->location) }}"
                            required class="input input-bordered @error('location') input-error @enderror">
                        @error('location')
                            <span class="text-error text-sm mt-1">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-control mb-4">
                        ...
                        <input type="url" name="origin_url" id="origin_url"
                            value="{{ old('origin_url', $cctv->origin_url) }}" required
                    ...
                    <div class="form-control mb-6">
                        ...
                        <input type="url" name="stream_url" id="stream_url"
                            value="{{ old('stream_url', $cctv->stream_url) }}" required
